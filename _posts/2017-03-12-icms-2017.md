...
Sciences](https://www.icms.org.uk/).
...
-   Researchers interested in solving [Group
    ...
    for GAP;
-   Others interested in the [SageMath](https://www.sagemath.org/)
...
software correct?](https://mikecroucher.github.io/MLPM_talk/) in which he
...
-   [nbconvert](https://nbconvert.readthedocs.io/en/latest/): convert a
    ...
    [Jinja2](https://palletsprojects.com/p/jinja/) template). It is used by
    [https://nbviewer.jupyter.org](https://nbviewer.jupyter.org/) to create
...
nbval, a [pytest](https://doc.pytest.org/en/latest/) plug-in, works as
...
Notebook](https://nbviewer.jupyter.org/github/ipython/ipywidgets/blob/master/docs/source/examples/Widget%20List.ipynb)
...
[Hans Fangohr](https://www.southampton.ac.uk/~fangohr/) from the
[University of Southampton](https://cmg.soton.ac.uk/) reported on using
...
[SageMath](https://www.sagemath.org/) computational mathematics software
